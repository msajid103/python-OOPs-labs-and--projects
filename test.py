...
class Functionality:
    def __init__(self,window=None):
        ...
        # Label(tkWindow,text="Well come!",font='sans 20 bold',bg="Violet").place(x=80,y=5)
        Label(tkWindow, text="facebook",font='sans 30 bold',bg="Blue",fg="White").place(x=80,y=190)
        username = StringVar()
    ...
    def Button(self,window):
        ...
        Button(Window, text="🔎🔎", command=partial(User.searchMember, self, name, Window),
              fg="Blue",activebackground="Blue").grid(row=0,column=0)
        menubar = Menu(Window)
